<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminmanagement.aspx.cs"
    Inherits="lms_1.SuperAdmin.adminmanagement" %>
            ...
            <nav class="app-header navbar navbar-expand bg-body">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <!--begin::Navbar Search-->
                        <li class="nav-item">
                            <a class="nav-link" data-widget="navbar-search" href="../admin/admindashboard.aspx"
                                role="button">
                ...
                <div class="sidebar-wrapper">
                    <nav class="mt-2">
                        ...
                        <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="../SuperAdmin/admin.aspx" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="../SuperAdmin/adminmanagement.aspx" class="nav-link">
                                <i class="nav-icon bi bi-palette"></i>
                                <p>Admin Management</p>
                            </a>
                        </li>
                        <%-- <li class="nav-item">
                            <a href="../admin/studentmanagement.aspx" class="nav-link">
                                                ...
                                                <%-- <li class="nav-item">
                                                    <a href="../admin/book_returned.aspx" class="nav-link">
                                                        ...
                                                        <p>
                                                            Returned Status
                                                            <span
                                                                class="nav-badge badge text-bg-secondary me-3">7</span>
                                                        ...
                                                        <%-- <li class="nav-item menu-open">
                                                            ...
                                                            <%-- <li class="nav-item">
                                                                ...
                                                                <li class="nav-item">
                                                                    ...
                                                                    <ul class="nav nav-treeview">
                                                                        <li class="nav-item">
                                                                            <a href="../docs/components/main-header.html"
                                                                                class="nav-link">
                                                                                <i class="nav-icon bi bi-circle"></i>
                                                                                <p>Main Header</p>
                                                                            </a>
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <a href="../docs/components/main-sidebar.html"
                                                                                class="nav-link">
                                                                                <i class="nav-icon bi bi-circle"></i>
                                                                                <p>Main Sidebar</p>
                                                                            </a>
                                                                ...
                                                                <li class="nav-item">
                                                                    ...
                                                                    <ul class="nav nav-treeview">
                                                                        <li class="nav-item">
                                                                            <a href="../docs/javascript/treeview.html"
                                                                                class="nav-link">
                                                                                <i class="nav-icon bi bi-circle"></i>
                                                                                <p>Treeview</p>
                                                                            </a>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="../docs/browser-support.html"
                                                                        class="nav-link">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="../docs/how-to-contribute.html"
                                                                        class="nav-link">
                                                                        <i
...
<form id="form1" runat="server">
        ...
        <%--<div class="container py-4">
            <div class="card shadow p-4">--%>
                <h3 class="text-center text-primary mb-4">Super Admin Management</h3>

                <!-- ALERTS -->
                <asp:Panel ID="SuccessAlert" runat="server" CssClass="alert alert-success alert-dismissible fade show" Visible="false">
                    <strong>Success!</strong> <asp:Label ID="lblSuccessMsg" runat="server" />
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </asp:Panel>
                <asp:Panel ID="ErrorAlert" runat="server" CssClass="alert alert-danger alert-dismissible fade show" Visible="false">
                    <strong>Error!</strong> <asp:Label ID="lblErrorMsg" runat="server" />
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </asp:Panel>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        <asp:DropDownList ID="ddlLevel" runat="server" CssClass="form-select">
                            ...
                            <div class="col-12">
    <asp:Button ID="btnAddUser" runat="server" Text="Add" CssClass="btn btn-success w-100" OnClick="btnAddUser_Click" />
</div>
                </div>
                        <div class="login-card w-500" style="max-height: 2000px; max-width: 2000px;">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered text-center"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="level" HeaderText="User Level" />
                            <asp:CommandField ShowEditButton="True" ButtonType="Link" EditText='<i class="fas fa-pen text-success"></i>' HeaderText="Edit" />
                            <asp:CommandField ShowDeleteButton="True" ButtonType="Link" DeleteText='<i class="fas fa-trash text-danger delete-confirm"></i>' HeaderText="Delete" />
                        </Columns>
                    </asp:GridView>
                </div>
            </div>
