<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userdashboard.aspx.cs" Inherits="lms_1.user.userdashboard" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box text-bg-success">
                                    <div class="inner">
                                        <h3>
                                            <asp:Label ID="totalbooks" runat="server"></asp:Label>
                                        </h3>
                                        <p>Total Books</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box text-bg-warning">
                                    <div class="inner">
                                        <h3>
                                            <asp:Label ID="totalissuedbooks" runat="server"></asp:Label>
                                        </h3>
                                        <p>Books Issued</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box text-bg-danger">
                                    <div class="inner">
                                        <h3>
                                            <asp:Label ID="totalreturnedbooks" runat="server"></asp:Label>
                                        </h3>
                                        <p>Books Returned</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header bg-secondary text-white">
                                        <h4 class="mb-0">Monthly Book Issue/Return Summary</h4>
                                    </div>
                                    <div class="card-body">
                                        <asp:GridView ID="monthlydata" runat="server"
