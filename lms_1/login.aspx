<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="lms_1.login" %>
...
<%--                <form class="d-flex ms-3 flex-grow-1" role="search">
        ...
        <form id="form1" runat="server" class="d-flex justify-content-center align-items-center vh-100">
            ...
            <div class="login-card">
                <h2 class="text-center mb-4 text-white">Sign In to Your Account</h2>

                <!-- SUCCESS ALERT -->
                <asp:Panel ID="successAlert" runat="server" Visible="false"
                    CssClass="alert alert-success alert-dismissible fade show" role="alert">
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <asp:HyperLink ID="lnkForgotPassword" runat="server" NavigateUrl="forgotpassword.aspx"
                        CssClass="text-white">Forgot password?</asp:HyperLink>
                </div>

                <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="btn btn-primary w-100 mb-3"
                    OnClick="btnLogin_Click" />
                <p class="text-center text-white">
    don't have an account? <a href="registration.aspx" class="text-decoration-none text-warning">Sign Up</a>
</p>
            </div>
        </form>
