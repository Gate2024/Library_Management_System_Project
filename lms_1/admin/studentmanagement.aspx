<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentmanagement.aspx.cs"
    Inherits="lms_1.admin.studentmanagement" %>
    <!doctype html>
    <html lang="en">
            ...
            <main class="container mt-6">
                ...
                <div class="app-content-header">
                    ...
                    <div class="container-fluid">
                        ...
                        <form id="form1" runat="server">
                            <div class="login-card w-500" style="max-height: 2000px; " max-width: 2000px";>
                                <%-- <div class="container mt-5 border p-4 shadow-lg rounded">--%>
                                    <div class="d-flex justify-content-center align-items-center mb-4">
                                        <span style="font-size: 2rem;">👨‍🎓</span>
                                        <h2 class="ms-2 text-primary fw-bold m-0">Student Management</h2>
                                    </div>


                                    <%-- <h2 class="text-center mb-4 text-primary">👨‍🎓 Student Management</h2>--%>
                                            ...
                                            <%-- First Row Start --%>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <asp:DropDownList ID="ddlCourse" runat="server"
                                                            ...
                                                            <asp:ListItem Text="Bachelor Of Engineering" Value="BE" />
                                                            <asp:ListItem Text="Polytech" Value="Poly" />
                                                    ...
                                                    <!-- Department -->
                                                    <div class="col-md-3">
                                                        <asp:Label ID="LabelDept" runat="server" Text="Department:"
                                                            AssociatedControlID="txtDept" />
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <asp:DropDownList ID="ddlYear" runat="server"
                                                            CssClass="form-select">
                                                            <asp:ListItem Text="First Year" Value="first year" />
                                                            <asp:ListItem Text="Second Year" Value="second year" />
                                                            <asp:ListItem Text="Third Year" Value="third year" />
                                                            <asp:ListItem Text="Fourth Year" Value="fourth year" />
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                ...
                                                <%-- Second Row Start --%>
                                                    <div class="row mb-3">
                                                        ...
                                                        <!-- Mobile No -->
                                                        <div class="col-md-3">
                                                            <asp:Label ID="LabelMobile" runat="server" Text="Mobile No:"
                                                                AssociatedControlID="txtMobNo" />
                                                        ...
                                                        <div class="col-md-3">
                                                            <asp:Label ID="LabelDOB" runat="server"
                                                                Text="Date of Birth:" AssociatedControlID="txtDOB" />
                                                        ...
                                                        <!-- Status -->
                                                        <div class="col-md-3">
                                                            <asp:Label ID="LabelStatus" runat="server" Text="Status:"
                    ...
                    <div class="login-card w-500" style="max-width: 100%; overflow-x: auto;">
                        <div class="card shadow mt-4 p-3" style="max-width: 100%; overflow-x: auto;">
                            <h4 class="text-primary m-3">👨‍🎓 Student Records</h4>

                            <asp:GridView ID="GridView1" runat="server"
                                CssClass="table table-bordered table-hover text-center" AutoGenerateColumns="False"
                                DataKeyNames="student_id" OnRowEditing="GridView1_RowEditing"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="student_year" HeaderText="Year" />
                                    <asp:BoundField DataField="student_DOB" HeaderText="Date of Birth"
                                        DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False" />
                                    <asp:BoundField DataField="student_mobno" HeaderText="Mobile" />
                                    ...
                                    <asp:CommandField ShowEditButton="True"
                                        EditText='<i class="fas fa-pen text-success"></i>' HeaderText="Edit"
                                        ButtonType="Link" />
                                    <asp:CommandField ShowDeleteButton="True"
                                        DeleteText='<i class="fas fa-trash text-danger delete-confirm"></i>'
                                        HeaderText="Delete" ButtonType="Link" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
