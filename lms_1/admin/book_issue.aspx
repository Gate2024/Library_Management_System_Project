<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book_issue.aspx.cs" Inherits="lms_1.admin.book_issue" %>
...
<div class="d-flex justify-content-center align-items-center mb-4">
    ...
    <h2 class="ms-2 text-primary fw-bold m-0">Issued Book Management</h2>
</div>
                        ...
                        <%-- <asp:Label ID="lblMessage" runat="server" CssClass="mb-3 d-block"></asp:Label>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <label for="ddl_book_name" class="form-label">Select Book:</label>
                                    <asp:DropDownList ID="ddl_book_name" runat="server" CssClass="form-select" />
                                </div>
                                <div class="col-md-4">
                                    <label for="ddl_student_name" class="form-label">Select Student:</label>
                                    <asp:DropDownList ID="ddl_student_name" runat="server" CssClass="form-select" />
                                </div>
                                <div class="col-md-2">
                ...
                <div class="mb-3">
                    <asp:Button ID="btnAdd" runat="server" Text="Issue Book" CssClass="btn btn-success w-100"
    ...
    <div class="login-card w-500" style="max-height: 2000px; " max-width: 2000px";>
        ...
        <div class="card shadow mt-4 p-3">
            <h4 class="text-primary mb-3">Issued Book Records</h4>
            <asp:GridView ID="gvStudent" runat="server" CssClass="table table-bordered table-hover"
